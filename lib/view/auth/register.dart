...
class __RegisterPageStateState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: AttendanceColors.background,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                SizedBox(height: 20,),
                Text("Kejuruan"),
                FutureBuilder(future: _fetchKejuruanData(),
                    ...
                    items: listKejuruan.map((kejuruan){
                      return DropdownMenuItem<String>(
                        value: kejuruan['id'].toString(),
                         child: Text('${kejuruan['name']} (${kejuruan['code']})'),
                      );
                    }).toList(),
                ...
                SizedBox(height: 20,),
                Text("Batch"),
                FutureBuilder(future: _fetchBatch(),
                 builder: (context, snapshot){
                  if (isLoading) {
                    return const CircularProgressIndicator();
                  }
